...
public interface ImageApi {
     ...
     * @param bucketName 存储空间
     * @param resizeDTO 缩放参数
     * @return 文件字节数组  获取失败则为空
     */
    byte[] resize(ResizeDTO resizeDTO, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] compression(CompressedFormatEnum compressedFormatEnum, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] watermark(WatermarkDTO watermarkDTO, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] crop(CropDTO cropDTO, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] quality(QualityDTO qualityDTO, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] format(ImageFormatEnum imageFormatEnum, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] autoOrient(Integer value, String bucketName, String objectName);
     ...
     * @return  文件字节数组  获取失败则为空
     */
    byte[] circle(Integer value, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] indexCrop(Integer x, Integer y, Integer i, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] roundedCorners(Integer radius, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] blur(Integer radius, Integer deviation, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] rotate(Integer value, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] interlace(Integer value, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] bright(Integer value, String bucketName, String objectName);
     ...
     * @return 文件字节数组  获取失败则为空
     */
    byte[] sharpen(Integer value, String bucketName, String objectName);
